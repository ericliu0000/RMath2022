...
class ProblemGraphConstants:
    ...
    FULL_LAYOUT = {1: [0, 1.5, 0], 2: [1.5, 0, 0], 3: [3, -1.5, 0], 
            4: [1.5, -1, 0], 5: [0.75, -0.25, 0], 6: [0, 0.5, 0],
            7: [3, -1.5, 0], 8: [0, -1.5, 0], 9: [-3, -1.5, 0],
            10: [-1.5, -1, 0], 11: [0, -1, 0], 12: [1.5, -1, 0],
            13: [-3, -1.5, 0], 14: [-1.5, 0, 0], 15: [0, 1.5, 0],
            16: [0, 0.5, 0], 17: [-0.75, -0.25, 0], 18: [-1.5, -1, 0],
            20: [0.2, 2, 0], 21: [0.7, 2.5, 0], 22: [1.2, 2.6, 0],
            23: [1.7, 2.5, 0], 24: [2.2, 2, 0],
            101: [0, 0.5, 0], 102: [0.75, -0.25, 0], 103: [1.5, -1, 0],
            104: [0, -1, 0], 105: [-1.5, -1, 0], 106: [-0.75, -0.25, 0]}

    SPLIT_LAYOUT = {1: [0.5, 1.5, 0], 2: [2, 0, 0], 3: [3.5, -1.5, 0],
            4: [2, -1, 0], 5: [1.25, -0.25, 0], 6: [0.5, 0.5, 0],
            7: [3, -2, 0], 8: [0, -2, 0], 9: [-3, -2, 0],
            10: [-1.5, -1.5, 0], 11: [0, -1.5, 0], 12: [1.5, -1.5, 0],
            13: [-3.5, -1.5, 0], 14: [-2, 0, 0], 15: [-0.5, 1.5, 0],
            16: [-0.5, 0.5, 0], 17: [-1.25, -0.25, 0], 18: [-2, -1, 0],
            20: [0.2, 2, 0], 21: [0.7, 2.5, 0], 22: [1.2, 2.6, 0],
            23: [1.7, 2.5, 0], 24: [2.2, 2, 0],
            101: [0, 0.5, 0], 102: [0.75, -0.25, 0], 103: [1.5, -1, 0],
            104: [0, -1, 0], 105: [-1.5, -1, 0], 106: [-0.75, -0.25, 0]}