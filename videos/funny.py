...
class Funny(Scene):
    def construct(self):
        g1 = Graph([1, 2, 3, 4, 5], [(1, 2), (2, 3), (3, 4), (4, 5), (5, 1)], layout="kamada_kawai")
        g1.shift(LEFT * 2)
        ...
        self.play(g1.animate.change_layout(layout="spring"), g2.animate.change_layout(layout="spring"))
        ...
        self.play(text2.animate.shift(DOWN + RIGHT))
        self.wait(LONG_PAUSE_TIME)
